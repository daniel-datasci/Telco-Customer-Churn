...
/* 1 - What is the overall churn rate for the telecommunications company ? */
...
from telco;
/*========================================*/
/*  2 - what is the ratio between males and females in the company? */
SELECT
...
/*========================================*/
/*  3 - how many Internet Services we provide in our company? */
select InternetService, COUNT(InternetService) as Number
from telco
group by InternetService;
/*========================================*/
/*  4 - what is our Contract types we provide? */
select Contract, COUNT(Contract) as Number
from telco
group by Contract;
/*========================================*/
/*  5 - how many customers uses StreamingTV? */
...
/*========================================*/
/*  6 - what is the ratio between users who streaming movies to StreamingTV subscribers? */
...
FROM telco;
/*========================================*/
/*  7 - Is there a strong relationship between the monthly recharge rate and the dependents? */
...
GROUP BY Dependents;
/*========================================*/
/*  8 - who is the the most important customer in the company according to Monthly and Total charges? */
SELECT top 1 customerID, MonthlyCharges, TotalCharges
FROM telco
ORDER BY MonthlyCharges DESC, TotalCharges DESC;
/*========================================*/
/*  9 - how many payment methods we provide? and what is the ratio between each others? */
